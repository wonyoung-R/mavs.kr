...
export function ColumnView() {
    ...
    useEffect(() => {
        ...
        const fetchData = fetch('/api/columns').then(res => res.json());
    ...
    return (
        <motion.div
            ...
            className="w-full max-w-5xl mx-auto space-y-8 px-4 pt-4 pb-20"
        >
            {/* Header */}
            <div className="text-center mb-6 pt-2">
                <h2 className="text-2xl md:text-3xl font-bold text-white mb-2">MAVS Column & Insight</h2>
