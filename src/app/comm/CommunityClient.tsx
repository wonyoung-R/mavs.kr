      ...
      <Card className="bg-slate-900/50 backdrop-blur-xl border-white/10 hover:border-blue-500/30 transition-all group overflow-hidden h-full flex flex-col">
        <CardContent className="p-5 flex flex-col h-full">
          ...
          <Link href={`/comm/${post.id}`} className="flex-1">
            <h3 className="text-lg font-bold text-white mb-4 leading-snug group-hover:text-blue-300 transition-colors">{post.title}</h3>
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className={`px-2 py-0.5 rounded text-[10px] border shrink-0 ${
                  post.category === 'market' ? 'bg-green-500/10 border-green-500/20 text-green-400' :
                  post.category === 'meetup' ? 'bg-purple-500/10 border-purple-500/20 text-purple-400' :
                  post.category === 'news' ? 'bg-blue-500/10 border-blue-500/20 text-blue-400' :
